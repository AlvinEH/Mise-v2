        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-bold text-m3-on-surface-variant mb-2 pl-1">
                  Location
                </label>
                <div className="relative">
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-3 bg-m3-surface-variant/20 border border-m3-outline/20 rounded-2xl outline-none focus:border-m3-primary font-medium transition-all group"
                  >
                        ...
                        >
                          <button
                            ...
                            className={`w-full text-left px-4 py-3 text-sm font-bold transition-colors hover:bg-m3-primary/5 ${
                              formData.location === '' ? 'text-m3-primary bg-m3-primary/5' : 'text-m3-on-surface'
                            }`}
                          >
                            Uncategorized
                          </button>
